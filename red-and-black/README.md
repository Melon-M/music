# Red & Black (Bayonetta) for Solo Piano
...
Up to and not including the *Sonoro* section:
- Fixed some (classically) bad harmonic practices such as omitting the third.
- Added more LH voices.

Will try to look at the rest of the music and make improvements in the near future as well...

Also planning to write some notes regarding the thought process behind this arrangement. Who knows when it will actually happen...
